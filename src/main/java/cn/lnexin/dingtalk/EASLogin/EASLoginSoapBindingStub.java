...
public class EASLoginSoapBindingStub extends org.apache.axis.client.Stub implements cn.lnexin.dingtalk.EASLogin.EASLoginProxy {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnClass(cn.lnexin.dingtalk.client.WSContext.class);
    ...
    public EASLoginSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        cls = cn.lnexin.dingtalk.client.WSContext.class;
    ...
    public cn.lnexin.dingtalk.client.WSContext login(String userName, String password, String slnName, String dcName, String language, int dbType) throws java.rmi.RemoteException {
        ...
        try {        Object _resp = _call.invoke(new Object[] {userName, password, slnName, dcName, language, new Integer(dbType)});
            ...
            if (_resp instanceof java.rmi.RemoteException) {
                ...
                extractAttachments(_call);
                try {
                    return (cn.lnexin.dingtalk.client.WSContext) _resp;
                } catch (Exception _exception) {
                    return (cn.lnexin.dingtalk.client.WSContext) org.apache.axis.utils.JavaUtils.convert(_resp, cn.lnexin.dingtalk.client.WSContext.class);
                }
            }
        } catch (org.apache.axis.AxisFault axisFaultException) {
            throw axisFaultException;
